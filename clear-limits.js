...
dotenv.config();
var MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/quiz-app';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db.collection('rateLimits').deleteMany({})];
                case 2:
                    _a.sent();
                ...
                case 4:
                    e_1 = _a.sent();
                    console.error('Error clearing rate limits:', e_1);
                    return [3 /*break*/, 7];
