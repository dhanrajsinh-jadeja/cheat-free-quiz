...
import { timeTakenDistributionData } from '../mockData';

const TimeTakenDistributionChart: React.FC = () => {
    return (
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col h-[300px]">
            <h3 className="text-sm font-bold text-slate-700 mb-4 px-2">6. Time Taken Distribution</h3>
            <div className="flex-1 min-h-0">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={timeTakenDistributionData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
